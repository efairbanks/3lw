...
#define VIN_5V0 5.11
#define VIN_5V0_FP FLOAT2LFP(VIN_5V0)
#define VIN_3V3 3.2
#define VIN_3V3_FP FLOAT2LFP(VIN_3V3)
...
#define VOCT_NOUT_MAX_FP   FLOAT2LFP(VOCT_NOUT_MAX)
#define VOCT_POUT_MAX_FP   FLOAT2LFP(VOCT_POUT_MAX)
#define CV_NOUT_MAX_FP     FLOAT2LFP(CV_NOUT_MAX)
#define CV_POUT_MAX_FP     FLOAT2LFP(CV_POUT_MAX)
